...
public class BDDistricsCovid19Activity extends AppCompatActivity {
    private Button searchPreviousDataBddistricttButton;
    private Button bdistricttToworldtButton;
    private Button bdistricttTodivisiontButton;
    private Button bddistricttToworldtotalButton;
    private Button bdistricttTobdtButton;
    private Button bdistricttTobdtotalButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bddistrics_covid19);
        bdistricttToworldtButton=findViewById(R.id.bdistricttToworldtId);
        bddistricttToworldtotalButton=findViewById(R.id.bdistricttToworldtotalId);
        bdistricttTodivisiontButton=findViewById(R.id.bdistricttTodivisiontId);
        bdistricttTobdtButton=findViewById(R.id.bdistricttTobdtId);
        bdistricttTobdtotalButton=findViewById(R.id.bdistricttTobdtotalId);
        ...
        searchPreviousDataBddistricttButton=findViewById(R.id.searchPreviousDatabdistricttId);
        searchPreviousDataBddistricttButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BDDistricsCovid19Activity.this, BDDistrictTotalCovid19Activity.class);
                Bundle bundle=new Bundle();
                bundle.putString("key","districttotal");
        ...
        newConfirmedtv=findViewById(R.id.newConfirmedBdistricttId);
        newDeathstv=findViewById(R.id.newDeathBdistricttId);
        newRecoveredtv=findViewById(R.id.newRecoveredBdistricttId);
        totalConfirmedtv=findViewById(R.id.totalConfirmedBdistricttId);
        totalDeathstv=findViewById(R.id.totalDeathBdistricttId);
        totalRecoveredtv=findViewById(R.id.totalRecoveredBdistricttId);

        //hashMapArraylist = new ArrayList<>();


        bdistricttToworldtButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        bdistricttTodivisiontButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        bdistricttTobdtButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
      ...
      /*  bdistricttTobdtotalButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
      ...
      /*  bddistricttToworldtotalButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
*/
    ...
    private DatePickerDialog.OnDateSetListener dpickerlistener=new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            ...
            Toast.makeText(BDDistricsCovid19Activity.this,formated_date,Toast.LENGTH_LONG).show();
    ...
    private class GethashMapItems2 extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BDDistricsCovid19Activity.this);
            ...
            Toast.makeText(BDDistricsCovid19Activity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
