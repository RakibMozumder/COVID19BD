...
public class GlobalSummaryActivity extends AppCompatActivity {
   ...
   // ArrayList<HashMap<String,String>> hashMapArraylist;
    ...
    private class GethashMapItems2 extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            newConfirmedtv=findViewById(R.id.newConfirmId);
            newDeathstv=findViewById(R.id.newDeathId);
            newRecoveredtv=findViewById(R.id.newRecoverId);
            totalConfirmedtv=findViewById(R.id.totalConfirmId);
            totalDeathstv=findViewById(R.id.totalDeathId);
            totalRecoveredtv=findViewById(R.id.totalRecoverId);
            pDialog = new ProgressDialog(GlobalSummaryActivity.this);
           ...
           // txtView = dialog.findViewById(R.id.progressMessage);
            ...
            Toast.makeText(GlobalSummaryActivity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(String... urls) {
            ...
            final String globalsummary, date;
            final int newConfirmed, totalConfirmed, newDeaths, totalDeaths, newRecovered, totalRecovered;
           ...
           // Toast.makeText(GlobalSummaryActivity.this, "1", Toast.LENGTH_SHORT).show();
            ...
            if (jsonStr != null) {
                try {
                    ...
                    publishProgress(date, String.valueOf(newConfirmed), String.valueOf(newDeaths), String.valueOf(newRecovered), String.valueOf(totalConfirmed), String.valueOf(totalDeaths), String.valueOf(totalRecovered));
...
*/
            ...
            newConfirmedtv.setText(update[1]);
            newDeathstv.setText(update[2]);
            newRecoveredtv.setText(update[3]);
            totalConfirmedtv.setText(update[4]);
            totalDeathstv.setText(update[5]);
            totalRecoveredtv.setText(update[6]);
        }
